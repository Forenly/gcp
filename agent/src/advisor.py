"""Gemini-powered lawn-mower recommendation engine (/recommend).

Ingests a yard's specifications, lets Gemini reason over the MongoDB registry
via function-calling tools, and returns a grounded recommendation with a
deterministic 4-phase install rollout.
"""
import json
import math
import os
